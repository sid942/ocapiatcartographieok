// src/services/refeaSearch.ts
import { loadRefEA, refeaCityOf, refeaTitleOf, toNumberOrNull, haversineKm, type RefEARow } from "./refea";
import { REFEA_RULES } from "./refeaRules";
