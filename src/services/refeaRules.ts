...
export const REFEA_RULES: Record<string, Rules> = {
  ...
  "technico": { 
    ...
    forbidAny: ["paysagiste", "amenagements paysagers", "creation", "equitation", "hippique", "cheval", "aquaculture", "poisson", "foret", "bucheronnage", "animalerie", "canin", "felin", "fleuriste", "service a la personne", "seconde pro", "4eme", "3eme", "animaux de compagnie", "jardins"],
  },
  ...
  "silo": { // Agent de silo (OUVERTURE MAXIMALE)
    mustAny: ["cereales", "grain", "collecte", "stockage", "silo", "magasinage", "agroalimentaire", "qualite", "polyvalent", "agricole", "industries agroalimentaires", "transformation", "bio industries", "conduite de systemes industriels", "cgea", "grandes cultures", "equipements agricoles"],
  ...
  "responsable_silo": { // Responsable de silo (OUVERTURE MOYENNE)
    mustAny: ["cereales", "grain", "collecte", "stockage", "qualite", "logistique", "silo", "approvisionnement", "responsable", "industries agroalimentaires", "management agricole", "cgea", "grandes cultures"],
  ...
  "technicien_culture": {
    ...
    // BLINDAGE ANTI BUCHERON / VIN / LYCEE
